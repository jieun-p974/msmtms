...
public class SomoShowDetailView extends JDialog {
	...
	void newObject(OrderVO vo) {
		lbSomoName = new JLabel("¼Ò¸ðÇ°¸í");
		lbSomoName.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		
		lbWarranty = new JLabel("Æò±Õ¼Ò¸ðÀÏ");
		lbWarranty.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		
		lbExp = new JLabel("À¯Åë±âÇÑ");
		lbExp.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		...
		tfWarranty.setFont(new Font("HYÁß°íµñ", Font.PLAIN, 12));
		
		tfExp = new JTextField(vo.getAcexp());
		tfExp.setFont(new Font("HYÁß°íµñ", Font.PLAIN, 12));
