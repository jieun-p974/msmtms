...
public class MachineShowDetailView extends JDialog {
	...
	public MachineShowDetailView(OrderVO vo) {
		setFont(new Font("HYÁß°íµñ", Font.PLAIN, 12));
		setTitle("±â±¸ »ó¼¼º¸±â");
		newObject(vo);
		addLayout(vo);
	}
	...
	void newObject(OrderVO vo) {
		lbMachineName = new JLabel("±â±¸¸í");
		lbMachineName.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		lbMethod = new JLabel("Æ¯Â¡");
		lbMethod.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		lbChangeCycle = new JLabel("±³È¯ÁÖ±â");
		lbChangeCycle.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		lbManagement = new JLabel("°ü¸®¹æ¹ý");
		lbManagement.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		lbSignificant = new JLabel("Æ¯ÀÌ»çÇ×");
		lbSignificant.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		lbPrice = new JLabel("°¡°Ý");
		lbPrice.setFont(new Font("HY°ß°íµñ", Font.PLAIN, 15));
		tfName = new JTextField(vo.getName());
		tfName.setFont(new Font("HYÁß°íµñ", Font.PLAIN, 12));
		tfCycle = new JTextField(vo.getMachinecycle());
		tfCycle.setFont(new Font("HYÁß°íµñ", Font.PLAIN, 12));
		tfPrice = new JTextField(vo.getAmsprice());
		tfPrice.setFont(new Font("HYÁß°íµñ", Font.PLAIN, 12));
